...
docs/
  ...
  modules/                         # 5 个模块契约
    a-intake/                      # 项目管理与资料接入
    b-parsing/                     # 文件解析与 AI 初稿生成
    c-agent/                       # AI 对话助手
    d-workbench/                   # 可视化编辑器（TipTap）
    e-render/                      # 版本管理与 PDF 导出
...
| 模块 | 职责 | 契约文档 |
|---|---|---|
| A 项目管理 | 项目 CRUD、文件上传、Git 接入、补充文本 | [contract.md](./modules/a-intake/contract.md) |
...
| D 编辑器 | TipTap 所见即所得编辑，A4 画布 | [contract.md](./modules/d-workbench/contract.md) |
